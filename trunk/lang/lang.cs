 ...
 *  
 * @author "SmEjDiL" <malyl@col.cz>, "David Krotil" <David.Krotil@mu-sokolov.cz>, Uwe L. Korn <uwelk@xhochy.org>, jberanek
 * @package Schoorbs
 * @subpackage Language
 */
...
# Used in style.inc
$vocab["mrbs"]               = "Schoorbs - Rezervační systém";
...
$vocab["valid_time_of_day"]  = "platný časový úsek dne.";
