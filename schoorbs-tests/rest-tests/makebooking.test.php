<?php
/**
 * This file tests the makeBooking REST-function
 * 
...
/**
 * Testsuite for the makeBooking REST-function
 * 
 * @package Schoorbs-Test
 * @subpackage REST
 * @author Uwe L. Korn <uwelk@xhochy.org>
 */ 
class REST_MakeBookingTest extends PHPUnit_Extensions_OutputTestCase
{
	/**
